...
export class AuthGuard implements CanActivate {
  ...
  async canActivate( // O método canActivate é chamado para verificar se o usuário está autenticado
   ...
   catch{ // Se o token não for válido, lança uma exceção de não autorizado
    throw new UnauthorizedException();
   }
  }
